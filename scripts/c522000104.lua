...
function s.initial_effect(c)
	...
	-- Once per turn, add 1 Bey Parts from your deck or GY to your hand
...
s.listed_names={522000105}
function s.addfilter(c)
	return c:IsAbleToHand() and c:IsSetCard(0x271)
end
...
function s.confilter (c,tp)
	return c:IsCode(522000105) and c:IsSummonPlayer(tp)
end 
